...
CREATE TABLE `defects` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_defects_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ell_defects_buffer`
--

DROP TABLE IF EXISTS `ell_defects_buffer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ell_defects_buffer` (
  `id` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `station_id` (`station_id`,`created_at`),
  KEY `idx_ell_defects_production_id` (`production_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ell_productions_buffer`
--

DROP TABLE IF EXISTS `ell_productions_buffer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ell_productions_buffer` (
  `id` int NOT NULL,
  `object_id` int NOT NULL,
  `station_id` int NOT NULL,
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `station_id_created_at_idx` (`station_id`,`created_at`),
  KEY `idx_ell_prod_station_esito_time` (`station_id`,`esito`,`start_time`),
  KEY `idx_ell_object_station_time` (`object_id`,`station_id`,`start_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `object_defects` (
  ...
  KEY `idx_object_defects_prod_defect_type` (`production_id`,`defect_type`),
  KEY `idx_object_defects_prod_defect_id` (`production_id`,`defect_id`),
  KEY `idx_object_defects_production_id` (`production_id`),
  KEY `idx_object_defects_defect_id_category` (`defect_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=15417 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `objects` (
  ...
  KEY `idx_objects_id_modulo` (`id_modulo`),
  CONSTRAINT `fk_objects_creator_station` FOREIGN KEY (`creator_station_id`) REFERENCES `stations` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=302056 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productions` (
  ...
  KEY `idx_productions_start_time_object` (`start_time`,`object_id`),
  KEY `idx_productions_last_station` (`last_station_id`,`id` DESC),
  KEY `idx_productions_station_esito_endtime` (`station_id`,`esito`,`end_time`),
  KEY `idx_productions_object_id` (`object_id`),
  KEY `idx_productions_station_start_esito` (`station_id`,`start_time`,`esito`),
...
) ENGINE=InnoDB AUTO_INCREMENT=294632 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=158272 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stops` (
  ...
  KEY `idx_status` (`status`),
  KEY `idx_stops_station_type_start` (`station_id`,`type`,`start_time`)
) ENGINE=InnoDB AUTO_INCREMENT=158259 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `str_visual_snapshot`
--

DROP TABLE IF EXISTS `str_visual_snapshot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `str_visual_snapshot` (
  `id` int NOT NULL AUTO_INCREMENT,
  `station_id` int NOT NULL,
  `timestamp` datetime NOT NULL,
  `cell_G` int DEFAULT '0',
  `cell_NG` int DEFAULT '0',
  `string_G` int DEFAULT '0',
  `string_NG` int DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `timestamp` (`timestamp`),
  KEY `station_id` (`station_id`),
  KEY `timestamp_2` (`timestamp`,`station_id`),
  CONSTRAINT `str_visual_snapshot_ibfk_1` FOREIGN KEY (`station_id`) REFERENCES `stations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3097 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-08-01 17:40:12
