...
class LmnVisualsPage extends StatefulWidget {
  ...
  final int station_1_out_ng;
  final int station_2_out_ng;
  final int station_1_in;
  final int station_2_in;
  ...
  final List<int> lmn1VPFCounts;
  final List<int> lmn2Counts;
  final List<int> lmn2VPFCounts;
  ...
  const LmnVisualsPage({
    ...
    required this.station_1_out_ng,
    required this.station_2_out_ng,
    required this.station_1_in,
    required this.station_2_in,
    ...
    required this.lmn1VPFCounts,
    required this.lmn2Counts,
    required this.lmn2VPFCounts,
  ...
  @override
  State<LmnVisualsPage> createState() => _LmnVisualsPageState();
}

class _LmnVisualsPageState extends State<LmnVisualsPage> {
