...
class StringatriceLoadingScreen extends StatefulWidget {
  const StringatriceLoadingScreen({super.key});

  @override
  State<StringatriceLoadingScreen> createState() =>
      _StringatriceLoadingScreenState();
}

class _StringatriceLoadingScreenState extends State<StringatriceLoadingScreen>
